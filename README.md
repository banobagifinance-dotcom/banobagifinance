...
- **หน้ารายละเอียด** (เข้าจากลิงก์หรือสแกน QR): แสดงข้อมูลครบ และปุ่มแก้ไข/ลบ (เมื่อเข้าสู่ระบบแล้ว)
- **เข้าสู่ระบบ**: ต้อง login ก่อนจึงจะเห็นปุ่ม เพิ่มสินทรัพย์, แก้ไขสินทรัพย์, ลบสินทรัพย์ (ใช้ Supabase Auth)
...
6. **เปิดใช้ Auth (สำหรับปุ่มเพิ่ม/แก้ไข/ลบ)**  
   - ไปที่ **Authentication** → **Providers** → เปิด **Email**  
   - ไปที่ **Authentication** → **Users** → **Add user** → สร้าง user ด้วยอีเมลและรหัสผ่าน (ใช้ค่านี้สำหรับเข้าสู่ระบบ)
